        ...
        <div className="bg-card p-6 rounded-[var(--radius-20)] shadow-xl border border-border">
            ...
            <div className="space-y-4">
                ...
                <button
                    ...
                    className="w-full px-4 py-3 bg-background hover:bg-primary-foreground/80 text-white font-bold rounded-lg transition duration-150 shadow-md flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    {isLoading ? (
